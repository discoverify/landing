  ...
  return (
    <>
      ...
      <section className="max-w-5xl mx-auto text-center mt-40">
        ...
        <h2 className="text-2xl inline-flex items-center text-gray-300">
          powered by
          <svg
